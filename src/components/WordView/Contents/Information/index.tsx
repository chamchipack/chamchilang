...
import { Bookmark, Plus, Volume2, ChevronRight } from 'lucide-react-native';
...
export default function Information({ data = atsui }: { data?: Word }) {
  const voca = useVocaModal({
    ...
    saveToWordbook: async (wordbookId, word) => {
      // TODO: 실제 저장 로직
      // await api.wordbooks.addWord(wordbookId, word);
      console.log('저장 완료:', { wordbookId, word });
    },
  });
